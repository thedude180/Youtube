...
import { Target, Plus, TrendingUp, CheckCircle2, Trash2, Sparkles, CalendarDays } from "lucide-react";
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-5xl mx-auto">
      <div className="flex justify-between items-center gap-4 flex-wrap">
        <h1 data-testid="text-page-title" className="text-2xl font-display font-bold">Business Goals</h1>
                  ...
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge
                          variant={statusVariant[goal.status] || "outline"}
