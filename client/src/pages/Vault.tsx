    ...
    <div className="min-h-screen p-3 lg:p-4 space-y-6 page-enter" data-testid="page-vault">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              {selectedGame
                ...
                : "Your complete video backup — organized by game"}
            </p>
          </div>
        </div>
      ...
      <div className="flex gap-3 items-center">
        <div className="relative flex-1">
          ...
          <Input
            placeholder={selectedGame ? "Search videos..." : "Search games..."}
            value={search}
      ...
      {!selectedGame ? (
        <div className="space-y-3">
          <Tabs value={activeTab} onValueChange={setActiveTab} data-testid="tabs-vault-filter">
            <TabsList>
