...
const items: CommandItem[] = [
  ...
  { label: "Videos", icon: Video, group: "Content Actions", path: "/content" },
  { label: "Channels", icon: Users, group: "Content Actions", path: "/content/channels" },
  { label: "Updated", icon: FileText, group: "Content Actions", path: "/content/updated" },
  ...
  { label: "General", icon: Settings, group: "Settings", path: "/settings" },
  { label: "Security", icon: Shield, group: "Settings", path: "/settings/security" },
