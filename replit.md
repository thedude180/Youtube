...
-   **Core Engines**:
    -   **Dual Pipeline System**: Live Stream (65 steps) and VOD (56 steps) pipelines across 9 phases, including live discovery and retention. VOD pipelines auto-spawn after live content publication.
    ...
    -   **Content Variation Engine**: Generates unique content per platform using 15 content angles, platform-specific voice profiles, and banned AI-phrase filtering.
