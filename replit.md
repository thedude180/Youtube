...
- **Full AI YouTube Team (14 agents)**: Strategy Layer: `ai-owner`, `ai-admin`, `ai-research-lead`. Content Layer: `ai-scriptwriter`, `ai-editor`, `ai-thumbnail-artist`, `ai-shorts-specialist`. Distribution Layer: `ai-seo-manager`, `ai-social-media-manager`, `ai-moderator`. Revenue Layer: `ai-brand-manager`, `ai-premium`, `ai-analyst`, `ai-user`. Engine: `server/ai-team-engine.ts`. All auto-provisioned, run every 6h via cron, displayed in CompetitiveEdge Team tab with 4-layer collaboration view. Sidebar shows `activeAgents/14`. Handoff map covers all 14 agents. AGENT_META in CompetitiveEdge.tsx covers all 14 with distinct icons and colors.