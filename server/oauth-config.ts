...
export const OAUTH_CONFIGS: Partial<Record<Platform, OAuthPlatformConfig>> = {
  ...
  x: {
    ...
    clientIdEnv: process.env.TWITTER_DEV_CLIENT_ID ? "TWITTER_DEV_CLIENT_ID" : "TWITTER_CLIENT_ID",
    clientSecretEnv: process.env.TWITTER_DEV_CLIENT_SECRET ? "TWITTER_DEV_CLIENT_SECRET" : "TWITTER_CLIENT_SECRET",
    requiresPKCE: true,
    pkceChallengeMethod: "S256",
