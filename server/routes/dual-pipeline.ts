...
async function runStreamPipelineStep(
  ...
  const prompts: Record<string, string> = {
    ...
    repurpose: isVod
      ...
      : `Cross-platform repurpose plan for "${sourceTitle}". Context: ${ctx("analyze")}. Unique posts for YouTube, Kick, TikTok, X, Discord. Do NOT generate Twitch posts — Twitch is used for live streaming only. Return JSON: { posts: array of {platform: string, content: string, hashtags: array, tone: string} }`,
