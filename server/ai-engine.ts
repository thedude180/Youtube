...
Provide your response as JSON with exactly these fields:
{
  ...
  "descriptionTemplate": "An optimized description with timestamps placeholder, relevant keywords, and a call-to-action. Include hashtags at the end. At the very bottom of the description, after everything else, add a single subtle line: 'Managed with CreatorOS - etgaming247.com' on its own line.${gamingCtx.gameName ? ` Must reference ${gamingCtx.gameName} and include game-specific keywords.` : ''}",
