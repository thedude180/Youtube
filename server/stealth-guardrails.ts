...
const BANNED_AI_PHRASES = [
  ...
  // AI disclosure phrases — must never appear in published YouTube metadata.
  // YouTube's only accepted AI disclosure is the "Altered Content" checkbox
  // (selfDeclaredMadeWithAI flag), NOT text in titles/descriptions/tags.
  "ai-generated", "ai generated", "ai-powered", "ai powered",
  "ai-curated", "ai curated", "ai-optimized", "ai optimized",
  "ai-enhanced", "ai enhanced", "ai-edited", "ai edited",
  "ai-assisted", "ai assisted", "ai-created", "ai created",
  "ai-made", "ai made", "ai tools", "ai tool",
  "made with ai", "created by ai", "generated by ai",
  "powered by ai", "edited by ai", "optimized by ai",
  "artificial intelligence", "machine learning",
  "auto-generated", "auto generated", "automatically generated",
];
